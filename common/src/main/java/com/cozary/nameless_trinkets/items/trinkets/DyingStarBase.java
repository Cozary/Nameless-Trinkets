...
public class DyingStarBase extends TrinketItem<DyingStarBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext tooltipContext, List<Component> tooltip,
        ...
        if (!config.isEnable) {
            ...
            tooltip.add(Component.translatable("tooltip.nameless_trinkets.dying_star_lore")
                    .withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Screen.hasShiftDown()) {
                if (Minecraft.getInstance().player.tickCount % 5 == 0) {
                    tooltip.add(Component.translatable("tooltip.nameless_trinkets.dying_star_1")
                            .withStyle(ChatFormatting.GOLD, ChatFormatting.ITALIC));
                } else {
                    tooltip.add(Component.translatable("tooltip.nameless_trinkets.dying_star_1")
                            .withStyle(ChatFormatting.GOLD, ChatFormatting.OBFUSCATED));
                ...
                for (Map.Entry<String, Float> entry : stats.entrySet()) {
                    ...
                    tooltip.add(
                            Component.translatable(entry.getKey() + entry.getValue()).withStyle(ChatFormatting.GOLD));
