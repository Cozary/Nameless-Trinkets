...
public class ExperienceMagnetBase extends TrinketItem<ExperienceMagnetBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltip, TooltipFlag flag) {
        ...
        if (!config.isEnable) {
            ...
            tooltip.accept(Component.translatable("tooltip.nameless_trinkets.experience_magnet_lore").withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Minecraft.getInstance().hasShiftDown()) {
                tooltip.accept(Component.translatable("tooltip.nameless_trinkets.experience_magnet_1", config.range).withStyle(ChatFormatting.GOLD));
            } else {
