...
public class PocketLightningRodBase extends TrinketItem<PocketLightningRodBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltip, TooltipFlag flag) {
        if (!trinketConfig.isEnable) {
            ...
            tooltip.accept(Component.translatable("tooltip.nameless_trinkets.pocket_lightning_rod_lore").withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Minecraft.getInstance().hasShiftDown()) {
                tooltip.accept(Component.translatable("tooltip.nameless_trinkets.pocket_lightning_rod_1").withStyle(ChatFormatting.GOLD));
            } else {
