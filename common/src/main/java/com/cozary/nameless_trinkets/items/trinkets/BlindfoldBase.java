...
public class BlindfoldBase extends TrinketItem<BlindfoldBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltip, TooltipFlag flag) {
        ...
        if (!config.isEnable) {
            ...
            tooltip.accept(Component.translatable("tooltip.nameless_trinkets.blindfold_lore").withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Screen.hasShiftDown()) {
                tooltip.accept(Component.translatable("tooltip.nameless_trinkets.blindfold_1").withStyle(ChatFormatting.GOLD));
                tooltip.accept(Component.translatable("tooltip.nameless_trinkets.blindfold_2").withStyle(ChatFormatting.GOLD));
