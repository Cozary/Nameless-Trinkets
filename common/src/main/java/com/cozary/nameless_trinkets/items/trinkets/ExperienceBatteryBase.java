...
public class ExperienceBatteryBase extends TrinketItem<ExperienceBatteryBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltip, TooltipFlag flag) {
        if (!trinketConfig.isEnable) {
            ...
            tooltip.accept(Component.translatable("tooltip.nameless_trinkets.experience_battery_lore").withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Screen.hasShiftDown()) {
                tooltip.accept(Component.translatable("tooltip.nameless_trinkets.experience_battery_1").withStyle(ChatFormatting.GOLD));
            } else {
