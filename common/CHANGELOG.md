...
- [Fertilizer] Improved logic to prioritize crops/saplings and added safety checks to prevent underwater growth near the
  surface. (@JahsonGA)

### Fixed

- [Four Leaf Clover] Fixed an issue where player-kill loot (e.g. Blaze Rods) wouldn't drop and extra rolls were not
  randomized.
