...
##How it works:
The **Cracked Crown** trinket grants the following effects:

- The player gains additional modifiers to several stats:
	- **Maximum Health**
	- **Movement Speed**
	- **Fly Speed**
	- **Attack Damage**
...
- **Modifiers**: Applied based on the indicated percentage.
