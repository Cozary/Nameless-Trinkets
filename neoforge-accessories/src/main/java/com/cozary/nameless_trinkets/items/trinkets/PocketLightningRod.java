...
public class PocketLightningRod extends TrinketItemAccessories<PocketLightningRodBase.Stats> {
    ...
    public void tick(ItemStack stack, SlotReference reference) {
        PocketLightningRodBase.Stats config = PocketLightningRodBase.INSTANCE.getTrinketConfig();
