...
public class LuckyRock extends TrinketItemAccessories<LuckyRockBase.Stats> {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext tooltipContext, List<Component> tooltip, TooltipFlag tooltipFlag) {
        ...
        if (!config.isEnable) {
            ...
            tooltip.add(Component.translatable("tooltip.nameless_trinkets.lucky_rock_lore").withStyle(ChatFormatting.AQUA, ChatFormatting.ITALIC));
            if (Screen.hasShiftDown()) {
                tooltip.add(Component.translatable("tooltip.nameless_trinkets.lucky_rock_1", config.percentageOfObtaining + "%").withStyle(ChatFormatting.GOLD));
            } else {
